...
rainy.addEventListener("click", () => {
  if (!rainy.classList.contains("play")) {
    ...
    rainy.src = "./Elements/pause-solid.svg";
    ...
    rainy.src = "./Elements/play-solid.svg";
    relaxingSound.src = "";
    relaxingSound.pause();
    console.log("Paused");
  }
...
function funcy() {
  ...
  cpTask != 0
    ...
    : (compTask.innerHTML =
        "<h3 style='color:blue'>Ops, No task Completed📃</h3>");
}
